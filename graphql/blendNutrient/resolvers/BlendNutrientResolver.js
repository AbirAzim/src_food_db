...
let BlendNutrientResolver = class BlendNutrientResolver {
    async addBlendNutrients() {
        ...
        for (let i = 0; i < obj.length; i++) {
            ...
            if (obj[i].parentIsCategory) {
                let blendCategory = await blendNutrientCategory_1.default.findOne({
                    blendId: obj[i].category,
                });
                obj[i].category = blendCategory._id;
                obj[i].parent = null;
                await blendNutrient_1.default.create(obj[i]);
            }
            else {
                let blendCategory = await blendNutrientCategory_1.default.findOne({
                    blendId: obj[i].category,
    ...
    async removeAllBlendNutrients() {
        await blendNutrient_1.default.deleteMany({});
        return 'done';
    }
    async mapToBlend() {
        let n = [
        ...
        for (let i = 0; i < n.length; i++) {
            ...
            if (!nutrient) {
                ...
                let blendNutrient = await blendNutrient_1.default.findOneAndUpdate({ blendId: String(n[i].mapTo) }, {
                    $set: {
                ...
                await mapToBlend_1.default.create({ srcUniqueNutrientId, blendNutrientId });
            }
        }
        return 'done';
    }
...
], BlendNutrientResolver.prototype, "addBlendNutrients", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => String),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], BlendNutrientResolver.prototype, "removeAllBlendNutrients", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => String),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], BlendNutrientResolver.prototype, "mapToBlend", null);
__decorate([
    (0, type_graphql_1.Mutation)(() => String),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
